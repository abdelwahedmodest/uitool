...
#add crud  operations buttons
# Add the "Operations" column to the HTML table
html+="<td><button type='button' class='btn btn-sm btn-success'>Create</button>"
html+="<button type='button' class='btn btn-sm btn-primary'>Read</button>"
html+="<button type='button' class='btn btn-sm btn-warning'>Update</button>"
html+="<button type='button' class='btn btn-sm btn-danger'>Delete</button></td>"
